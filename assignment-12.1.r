...
#applying anova test, For anova test lets first define null and alternative hypothesis
...
#but we don't know which pairs of groups are different. It's possible to perform multiple pairwise-comparison, 
...
#From above output we got some following groups for which there is a significant difference between the means.
